...
if(plt){
    ...
    variables.mod=c("C1Wv_Qstream")
    ##variables.mod=c("C4Wv_Qstream", "U1F4Wv_Qstrm", "U2F4Wv_Qstrm","U3F4Wv_Qstrm","U5F4Wv_Qstrm")
    ##variables.mod=c("C1Tc1_Qstream", "C1Tc2_Qstream", "C2Tc1_Qstream", "C2Tc2_Qstream", "C3Tc1_Qstream", "C3Tc2_Qstream", "C4Tc1_Qstream", "C4Tc2_Qstream", "C5Tc1_Qstream", "C5Tc2_Qstream")
    ##variables.mod=c("C1Wv_Qstream", "C2Wv_Qstream", "C3Wv_Qstream", "C4Wv_Qstream", "C5Wv_Qstream")
    ...
    plot.results(layout.mod=layout.mod, y.mod=y.mod, layout.obs=layout.obs, y.obs=y.obs, scales="free_y", xlim=as.POSIXct(c("2009-02-21 00:00","2009-08-28 12:00")), per.area=TRUE, hru.areas=su$model$hru.areas, file="../../output/adaptQ2.pdf")
